...
\begin{sidebar}
    \vspace{10cm}
    \normalfont \normalsize
    \huge Artificial Intelligence for Safeguarding Security and Privacy in the Age of the Internet of Things\\ 
    \vspace{-1.3cm}
\end{sidebar}
\vspace{3cm}
\begin{flushleft}
